...
module.exports = {
	name: 'turtle',
	description: 'Sends a random turtle image.',
	usage: '//turtle',
	args: false,
	argsCount: 0,
	guildOnly: false,
			...
			try {
				unsplash.photos.getRandomPhoto({ query: "turtle" })
					.then(result => result.json()).then(body => {
							...
							return message.channel.send({embed: turtleEmbed});
					});
			} catch(error) {
