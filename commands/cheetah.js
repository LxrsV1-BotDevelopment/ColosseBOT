...
module.exports = {
	name: 'cheetah',
	description: 'Sends a random cheetah image.',
	usage: '//cheetah',
	args: false,
	argsCount: 0,
	guildOnly: false,
			...
			secret: process.env.UNSPLASH_SECRET
				...
				unsplash.photos.getRandomPhoto({ query: "cheetah" })
					.then(result => result.json()).then(body => {
							...
							return message.channel.send({embed: cheetahEmbed});
					}).catch(error => {
